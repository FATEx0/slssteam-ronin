...
#Structured manifest locks maintained by Ronin. Manifest gids are quoted
#decimal strings because they may exceed YAML's portable integer range.
#ManifestPins:
#  123456:
#    locked: true
#    build_id: 123
#    depots:
#      123457: "1234567890123456789"
ManifestPins:
...
#Expose achievement and player-stat data for added games.
Achievements: yes

#Default Steam account used as the schema/stat owner when an added game is not
#owned by the current account. Per-app entries below override this value.
