...
{
	// Parse the on-disk decimal-string representation without throwing.
	// Manifest gids may use the complete uint64 range; signs, whitespace,
	// suffixes, empty values, and overflow are rejected.
	inline bool parseDecimalGid(const std::string& text, uint64_t& value)
	{
